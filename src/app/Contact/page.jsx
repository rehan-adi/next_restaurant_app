...
function page() {
  return (
    <div className='min-h-screen montserrat-font w-auto'>
         ...
         <h1 className='text-4xl mt-6 text-white montserrat-font tracking-widest font-bold'>CONTACT</h1>
         </div>
        ...
        ></iframe>
         ...
         <divv className='flex justify-center h-[230vh] w-auto bg-gray-100 flex-col items-center'>
              <div>
              ...
              <div className='flex mt-10 flex-col gap-10 justify-center items-center'>
                    ...
                    <p className='text-sm mb-2 opacity-70'>Name</p>
                      <input type="text" className='py-3 pr-28 outline-none pl-3 border-2 border-[#d9d9d9] rounded-lg' placeholder='Name' />
                    </div>
                     <div>
                     <p className='text-sm mb-2 opacity-70'>Phone</p>
                      <input type="text" className='py-3 outline-none pr-28 pl-3 border-2 border-[#d9d9d9] rounded-lg' placeholder='Phone' />
                     </div>
                    <div>
                    <p className='text-sm mb-2 opacity-70'>Email</p>
                      <input type="text" className='py-3 outline-none pr-28 pl-3 border-2 border-[#d9d9d9] rounded-lg' placeholder='Email' />
                    </div>
                  </div>
                  <div className='mt-10'>
                  ...
                  <div className='flex flex-col items-start justify-center gap-20 mt-32 mb-8'>
                      <div>
